...
export default function CerateScreen() {
  const router = useRouter(); // navigate the user to hame page after creation
  const { user } = useUser();
    ...
    >
      <View style={styles.contentContainer}>
        ...
        <ScrollView
          ...
          bounces={false}
          keyboardShouldPersistTaps="handled" // Changed to "always" if still having issues
